  ...
  projects: [
    {
      ...
      url: 'https://challenge-10-sena168.vercel.app/',
    },
    {
      id: '2',
      title: 'Portfolio 2',
    ...
    },
    {
      ...
      url: 'https://pomo-doro-murex.vercel.app/',
    },
  ] as Project[],
};
  ...
  testimonials: [
    {
      id: '1',
      quote:
        "Working with Sena Prasena was a smooth experience from start to finish. He translated our design into clean, responsive code and even suggested improvements we hadn't thought of. Highly recommended!",
      author: {
        name: 'Sarah Tan',
...
export const socialLinks = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/Sena168/',
    icon: 'facebook',
  },
  {
    name: 'Instagram',
    href: 'https://youtube.com/@088-sena?si=r6LYZk3N66xyVFh5',
    icon: 'instagram',
  },
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/sena168/',
    icon: 'linkedin',
  },
...
export const footerData = {
  copyright: '© 2023 Sena Prasena. All rights reserved.',
  socialLinks,
};
